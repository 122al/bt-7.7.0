...
if [ -d "/www/server/phpmyadmin/pma" ];then
	...
	if [ "${EN_CHECK}" ];then
		curl https://raw.githubusercontent.com/122al/bt-7.7.0/main/install/update6_en.sh|bash
	else
		curl https://raw.githubusercontent.com/122al/bt-7.7.0/main/install/update6.sh|bash
	fi
